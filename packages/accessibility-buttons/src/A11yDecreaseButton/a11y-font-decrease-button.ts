...
if (!customElements.get('accessibility-font-decrease')) {
  customElements.define('accessibility-font-decrease', A11yFontDecreaseButton)
}

export default A11yFontDecreaseButton
