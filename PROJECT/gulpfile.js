...
gulp.task('unify-scripts',  function() {
	var unminify = gulp.src([
		...
		.pipe(concat('accessibility-buttons-3.0.0.js'))
		.pipe(gulp.dest(paths.scripts.dest));
	...
	var minify = gulp.src([
		...
		.pipe(concat('accessibility-buttons-3.0.0.min.js'))
		.pipe(gulp.dest(paths.scripts.dest));
...
gulp.task('copy', function () {
	...
	// Copy Scripts
	   var script =	gulp.src([
	   						paths.scripts.dest + 'accessibility-buttons-3.0.0.js',
	   						paths.scripts.dest + 'accessibility-buttons-3.0.0.min.js'
	   					])
